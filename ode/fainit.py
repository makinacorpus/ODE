from ode import models, faforms
import logging
...
def includeme(config):
    ...
    if session_factory is not None:
        # pyramid_alchemy
        session_factory = 'ode.models.DBSession'
    else:
        # Akhet
        session_factory = 'ode.models.Session'
